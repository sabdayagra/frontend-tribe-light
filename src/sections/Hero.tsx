      ...
      <div className="container">
        <div className="md:flex items-center">
          <div className="md:w-[478px]">
            ...
            <p className="text-xl text-[#010D3E] tracking-tight mt-6 ">Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere molestias quas, sequi cum provident eaque nulla. Ea maiores eum modi! Saepe libero aliquam sint.</p>
