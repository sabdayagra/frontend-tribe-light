    ...
    <section className="py-24 bg-white">
      <div className="container">
        <div className="section-heading">
          ...
          <p className="section-description mt-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis fuga, consequatur repudiandae fugiat labore soluta ducimus qui, libero, nisi aliquam quibusdam delectus perferendis.</p>
        </div>
